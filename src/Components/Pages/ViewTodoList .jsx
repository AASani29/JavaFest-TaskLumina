  ...
  const fetchAndCheckRewards = async () => {
    try {
      ...
      if (newRewards.length > 0 && !hasNotified) {
        const notificationMessages = newRewards.map(
          (reward) => `You have earned the ${reward.badge} reward!`
        );
  ...
  return (
    <div className="dashboard">
      ...
      <main className="content">
        <Topbar />
        <div className="Hero">
          <div className="hero-today">All Tasks</div>
          ...
          <div className="task-list">
            ...
            {showDueTasks &&
              (getDueTasks().length > 0 ? (
                ...
                >
                  No due tasks. Keep up the great work, you're on top of
                  everything! <FaRegSmileBeam />
                </p>
              ))}
            ...
            {showUpcomingTasks &&
              (getUpcomingTasks().length > 0 ? (
                ...
                >
                  No upcoming tasks. You're well prepared for what's ahead, keep
                  it up! <FaRegSmileBeam />
                </p>
              ))}
          </div>
        </div>
        ...
        {showAddTaskForm && (
          <AddTaskForm toggleForm={toggleAddTaskForm} editTask={editTask} />
        )}
