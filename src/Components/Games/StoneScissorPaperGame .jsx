            ...
            <div className="game-container">
                <div className="game-content">
                    ...
                    <div className="buttons">
                        <button className="game-button" onClick={() => handleClick('Stone')} id="Stone">
                            <img src={require('../images/stone.png')} alt="Stone" width="80" height="80" className="images" /><br />
                            Stone
                        </button>
                        <button className="game-button" onClick={() => handleClick('Scissor')} id="Scissor">
                            <img src={require('../images/scissor.png')} alt="Scissor" width="80" height="80" className="images" /><br />
                            Scissor
                        </button>
                        <button className="game-button" onClick={() => handleClick('Paper')} id="Paper">
                    ...
                    <div className="bot-choice">
                        <img src={require('../images/bot.png')} alt="Bot" width="90" height="90" className="images" />
                        <b>Bot Chooses:</b>
                        {value ? (
                            <button className="game-button" id={value + "Ans"} disabled={true}>
                                <img src={require(`../images/${value.toLowerCase()}.png`)} alt={value} width="80" height="80" className="images" /><br />
                                {value}
                            </button>
                        ) : (
                ...
                <div className="game-instructions">
                    <h2>How to Play</h2>
                    <p>
                        Welcome to the Stone Scissor Paper game! Here’s how you play:
                    </p>
                    <ol>
                        <li>Select either Stone, Scissor, or Paper by clicking on the corresponding button.</li>
                        <li>The bot will randomly select one of the three options as well.</li>
                        <li>The winner is determined by the following rules:
                            <ul>
                        ...
                        <li>If you win, you earn a point. If the bot wins, it earns a point.</li>
